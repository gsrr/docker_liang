...
INSTALLED_APPS = [
    ...
    'warehouse',
     #註冊了warehouse.apps.warehouseconfig 就不要再註冊warehouse了,但沒有辦法觸發celery任務,解決辦法,為了顯示中文名,先在apps.py改好
    #接著註冊warehouse.apps.WarehouseConfig,介面會變成中文,但是celery任務不會觸發,但此時後台已經是中文了,改回註冊warehouse,介面似乎不會改變,且celery任務會觸發
    "front_show",
]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'zuiryuwarehouse',  # 設定為你的 PostgreSQL 數據庫名稱
        'USER': 'zuiryu_ware',
        'PASSWORD': 'zuiryuauction8206',
        'HOST': 'localhost',  # 如果你的數據庫運行在本地
        'PORT': '5432',
    }
} #這是本地端的設定
